...
```bash
INIT=$(node "C:/Users/ACER/Documents/Casso/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/ACER/Documents/Casso/.claude/get-shit-done/templates/spec.md.
